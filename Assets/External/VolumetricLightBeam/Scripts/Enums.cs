namespace VLB
{
    ...
    public enum DirtyProps
    {
        ...
        CookieProps = 1 << 15,
        ShadowProps = 1 << 16,
        AllWithoutMaterialChange = Intensity | HDRPExposureWeight | Color | SideSoftness | Jittering | NoiseIntensity | NoiseVelocityAndScale | CookieProps | ShadowProps,
        OnlyMaterialChangeOnly = Attenuation | BlendingMode | ColorMode | Cone | Dimensions | RaymarchingQuality | NoiseMode,
